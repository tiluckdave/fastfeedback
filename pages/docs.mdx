...
```
<iframe src="https://fastfeedback.tiluckdave.in/embed/SITE_ID" />
```
...
```
<iframe src="https://fastfeedback.tiluckdave.in/embed/SITE_ID/ROUTE" />
```
...
function Feedback () {
    const API = 'https://fastfeedback.tiluckdave.in/api/feedback/SITE_ID
